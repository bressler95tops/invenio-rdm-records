...
export class DepositFormApp extends Component {
  constructor(props) {
    ...
    if (props.errors) {
      ...
      const deserialized = recordSerializer.deserializeErrors(props.errors);
      appConfig.errors = typeof deserialized === "string" ? deserialized : JSON.stringify(deserialized);
    }
